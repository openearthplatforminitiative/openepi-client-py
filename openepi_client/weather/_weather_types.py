...
#   filename:  https://api-test.openepi.io/weather/openapi.json
#   timestamp: 2023-11-13T13:15:49+00:00
...
class FeatureType(RootModel[Any]):
    root: Any = Field(..., title="FeatureType")
...
class ForecastTimeInstant(BaseModel):
    ...
    air_temperature: Optional[float] = Field(
        None, description="Air temperature", example=17.1, title="Air Temperature"
    )
    ...
    wind_speed: Optional[float] = Field(
        None, description="Speed of wind", example=5.9, title="Wind Speed"
    )
    wind_speed_of_gust: Optional[float] = Field(
        None, description="Speed of wind gust", example=15.9, title="Wind Speed Of Gust"
    )
...
class ForecastUnits(BaseModel):
    air_pressure_at_sea_level: Optional[str] = Field(
        None, example="hPa", title="Air Pressure At Sea Level"
    )
    air_temperature: Optional[str] = Field(None, example="C", title="Air Temperature")
    air_temperature_max: Optional[str] = Field(
        None, example="C", title="Air Temperature Max"
    )
    air_temperature_min: Optional[str] = Field(
        None, example="C", title="Air Temperature Min"
    )
    cloud_area_fraction: Optional[str] = Field(
        None, example="%", title="Cloud Area Fraction"
    )
    cloud_area_fraction_high: Optional[str] = Field(
        None, example="%", title="Cloud Area Fraction High"
    )
    cloud_area_fraction_low: Optional[str] = Field(
        None, example="%", title="Cloud Area Fraction Low"
    )
    cloud_area_fraction_medium: Optional[str] = Field(
        None, example="%", title="Cloud Area Fraction Medium"
    )
    dew_point_temperature: Optional[str] = Field(
        None, example="C", title="Dew Point Temperature"
    )
    fog_area_fraction: Optional[str] = Field(
        None, example="%", title="Fog Area Fraction"
    )
    precipitation_amount: Optional[str] = Field(
        None, example="mm", title="Precipitation Amount"
    )
    precipitation_amount_max: Optional[str] = Field(
        None, example="mm", title="Precipitation Amount Max"
    )
    precipitation_amount_min: Optional[str] = Field(
        None, example="mm", title="Precipitation Amount Min"
    )
    probability_of_precipitation: Optional[str] = Field(
        None, example="%", title="Probability Of Precipitation"
    )
    probability_of_thunder: Optional[str] = Field(
        None, example="%", title="Probability Of Thunder"
    )
    relative_humidity: Optional[str] = Field(
        None, example="%", title="Relative Humidity"
    )
    ultraviolet_index_clear_sky_max: Optional[str] = Field(
        None, example="1", title="Ultraviolet Index Clear Sky Max"
    )
    wind_from_direction: Optional[str] = Field(
        None, example="degrees", title="Wind From Direction"
    )
    wind_speed: Optional[str] = Field(None, example="m/s", title="Wind Speed")
    wind_speed_of_gust: Optional[str] = Field(
        None, example="m/s", title="Wind Speed Of Gust"
    )


class GeometryType(RootModel[Any]):
    root: Any = Field(..., title="GeometryType")
...
class SolarTime(BaseModel):
    time: str = Field(..., example="2019-12-03T13:52:13Z", title="Time")


class Type(RootModel[Any]):
    root: Any = Field(..., title="Type")
...
class WeatherApiModelsMetSunriseTypesPointGeometry(BaseModel):
    coordinates: List[float] = Field(
        ..., example=[60.5, 11.59, 1001], min_length=2, title="Coordinates"
    )
    type: GeometryType
