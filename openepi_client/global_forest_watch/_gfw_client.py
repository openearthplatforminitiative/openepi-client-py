...
from ._gfw_types import GFWAccountInfo, GFWApiKey, GFWPagedDatasetResponse, GFWDataset
...
class GlobalForestWatchClient:
    ...
    def create_geostore(self, geometry: Geometry):
        return CreateGeostoreRequest(
            geometry=geometry, http_client=self.http_client
        ).post_sync()
