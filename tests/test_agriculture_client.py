...
from openepi_client.agriculture import AgricultureClient, AsyncAgricultureClient, PeakTimingEnum, IntensityEnum
...
class TestAgricultureClient:
    ...
    @pytest.mark.asyncio
    @patch("openepi_client.agriculture.AsyncAgricultureClient.get_summary", new_callable=AsyncMock)
